	...
	if widget['type'] == 'stat':
		...
		if widget['data']['raw_sensors'] is not None:
			try:
				...
				print "Raw sensors calc activated but no values provided: " + e
		...
		if widget['data']['paw'] is not None:
			try:				
				...
				#catch activated calcs that are unpopulated -- to be fixed in the interface
				print "PAW calc activated but no values provided: " + e
		...
		if widget['data']['chilling_portions'] is not None:
			try:
				...
				#catch activated calcs that are unpopulated -- to be fixed in the interface
				print "Chill portions calc activated but no values provided: " + e
		...
		if widget['data']['degree_days'] is not None:
			try:
				...
				#catch activated calcs that are unpopulated -- to be fixed in the interface
				print "Degree days calc activated but no values provided: " + e
		...
		if widget['data']['chilling_hours'] is not None:
			try:
				...
				#catch activated calcs that are unpopulated -- to be fixed in the interface
				print "Chill hours calc activated but no values provided: " + e
		...
		if widget['data']['evapo'] is not None:
			try:
				...
				#catch activated calcs that are unpopulated -- to be fixed in the interface
				print "ETo calc activated but no values provided: " + e
		...
		if widget['data']['dew_point'] is not None:
			...
			try:	
				...
				#catch activated calcs that are unpopulated -- to be fixed in the interface
				print "Dew point calc activated but no values provided: " + e
		...
		if widget['data']['ex_ec'] is not None:
			try:
				...
				#catch activated calcs that are unpopulated -- to be fixed in the interface
				print "EX EC calc activated but no values provided: " + e
